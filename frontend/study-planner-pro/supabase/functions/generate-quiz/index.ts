...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are a quiz generator. Create engaging, educational quiz questions based on study notes.
...
- Include clear, concise explanations for correct answers
...
Return ONLY valid JSON in this EXACT format:
{
  "questions": [
    ...
    const userPrompt = `Create 5 quiz questions (${difficulty || 'mixed'} difficulty) based on these notes:\n\n${notesContext}\n\nReturn ONLY the JSON object, no additional text.`;
